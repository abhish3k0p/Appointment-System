// app/patient/appointments/past/page.tsx
'use client';
...
export default function PastAppointments() {
  ...
  useEffect(() => {
    axios.get('/patient/past')
      .then(res => setAppointments(res.data))
      .catch(() => toast.error('Failed to fetch past appointments'))
      .finally(() => setLoading(false));
  }, []);

  if (loading) return <div className="p-6">Loading...</div>;

  if (!appointments.length) return <div className="p-6">No past appointments.</div>;
